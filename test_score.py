...
class TestScore(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.bj.append(cls.bd0).append(cls.bd1)
        cls.bj.append(cls.bd2).append(cls.bd3)
    ...
    def test_boost(self):
        ...
        self.assertEqual(
            ...
            (0 * 1.0) / ((1 - 0.75) + 0.75 * 1 / (1 / 4)),
            BM25F.weight('テスト', self.bd0, self.bj, boost=boost))
    ...
    def test_b(self):
        ...
        self.assertEqual(
            ...
            (0 * 1.0) / ((1 - 0.75) + 0.75 * 1 / (1 / 4)),
            BM25F.weight('テスト', self.bd0, self.bj, b=b))

    def test_entropy(self):
        self.assertEqual(
            log((4 - 3 + 0.5) / (3 + 0.5)),
            # ~ -0.8472978603872037
            BM25F.entropy('テスト', self.bj))
        self.assertEqual(
            log((4 - 1 + 0.5) / (1 + 0.5)),
            # ~ 0.8472978603872037
            BM25F.entropy('モニタ', self.bj))
    ...
    def test_bm25f(self):
        ...
        self.assertAlmostEqual(
            ...
            BM25F.bm25f(query, self.bd0, self.bj))
    ...
    def test_k1(self):
        ...
        self.assertAlmostEqual(
            ...
            BM25F.bm25f(query, self.bd0, self.bj, k1=2.0))
